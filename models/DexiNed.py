...
# Defines the generator (DexiNed) that consists of dense and upconv blocks
# with two conv operations
# Code and idea originally from Xavier Soria's architecture.
...
if __name__ == '__main__':
    ...
    with SummaryWriter(comment='DexiNed') as w:
